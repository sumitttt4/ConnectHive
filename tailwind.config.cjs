module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        // name: [size, { lineHeight, fontWeight not set here }]
        'display': ['3rem', { lineHeight: '1.05' }], // 48px (desktop default)
        'h2': ['2.25rem', { lineHeight: '1.06' }], // 36px (desktop default)
        'h3': ['1.5rem', { lineHeight: '1.1' }], // 24px
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(135deg, #0ea5e9 0%, #7dd3fc 50%, #a855f7 100%)',
      },
      animation: {
      ...
      screens: {
        'xs': '390px', // Mobile-first breakpoint for smallest devices
      }
    },
  },
  plugins: [],
